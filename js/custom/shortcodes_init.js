...
function initShortcodes(container) {
	...
	// Contact form
	if (container.find('.sc_contact_form .sc_contact_form_submit:not(.inited):not(.contact_form_1)').length > 0) {
		container.find(".sc_contact_form .sc_contact_form_submit:not(.inited):not(.contact_form_1)")
			.addClass('inited')
			.click(function(e){
