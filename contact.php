...
<!-- Mirrored from kidscare-html.axiomthemes.com/features-pages-contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jul 2024 07:07:31 GMT -->
...
<body class="page page-template-default themerex_body wide top_panel_above theme_skin_kidscare">
		...
		<div class="boxedWrap">
										...
										<div class="container">
											...
											<div class="columnsWrap sc_columns custom_columns sc_columns_count_2">
												<div class="columns1_2 sc_column_item sc_column_item_1 odd first">
													...
													<iframe
														src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2918.7872535753763!2d-81.31657262521026!3d42.98275497114186!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882ef03f1e2c43b3%3A0x40f496db320ae590!2s895%20Guildwood%20Blvd%2C%20London%2C%20ON%20N6H%205T1%2C%20Canada!5e0!3m2!1sen!2sin!4v1722514703837!5m2!1sen!2sin"
			...
			s-2.748-52.506-7.347-76.8h70.494c8.576,24.073,13.653,49.801,13.653,76.8c0,27-5.077,52.727-13.662,76.8H402.244z" />
									...
									<section class="no_padding">
										<div class="container">
											<div
												class="columnsWrap sc_columns sc_columns_count_3 margin_top_middle margin_bottom_middle">
												<div
													class="columns2_3 sc_column_item sc_column_item_1 odd first span_2">
													<div class="sc_contact_form sc_contact_form_contact contact_form_1">
														<h1 class="title">Send Us a Message</h1>
														<form class="contact_1" method="post" action="" name="oc_form" onsubmit="return alertMsg(event)">
	<div class="columnsWrap">
		<div class="columns1_3">
			<label class="required" for="contact_form_username">Name</label>
			<input type="text" name="name" id="contact_form_username" required>
		</div>
		<div class="columns1_3">
			<label class="required" for="contact_form_email">E-mail</label>
			<input type="text" name="email" id="contact_form_email" required>
		</div>
		<div class="columns1_3">
			<label class="required" for="contact_form_subj">Subject</label>
			<input type="text" name="subject" id="contact_form_subj" required>
		</div>
	</div>
	<div class="message">
		<div>
			<label class="required" for="contact_form_message">Your Message</label>
			<textarea id="contact_form_message" class="textAreaSize" name="message" required></textarea>
		</div>
	</div>
	<div class="sc_contact_form_button">
		<div class="squareButton sc_button_size sc_button_style_global global ico">
			<button type="submit" name="send" class="contact_form_submit icon-comment-1">Send Message</button>
		</div>
	</div>
	...
	<div class="formAlert"></div>
												...
												<div
													class="columns1_3 sc_column_item sc_column_item_3 odd after_span_2">
			...
			<div class="footerContentWrap">
				<footer class="footerWrap footerStyleLight contactFooterWrap">
					<div class="main contactFooter">
						<section>
							<div class="logo">
								<a href="index.html">
									<img src="images/oceanic-logo-3.png" alt="">
								</a>
							</div>
							<div class="contactAddress">
								<address class="addressRight">
									Phone: +1 226 700 9373 <br>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+1 519 701 5740 </address>
								<address class="addressLeft">
									 895 Guildwood Boulevard, <br/>London, ON N6H 5T1 </address>
							</div>
				...
				<div class="copyWrap">
					<div class="copy main">
						<div class="copyright">
							<a href="http://themeforest.net/user/axiomthemes/portfolio">Oceanic</a> &copy; 2024 All Rights Reserved
							Created by : 
							<a href="https://ignitax.com/">Ignitax</a>
						</div>
	...
	function alertMsg(event) {
		...
		const name = document.querySelector('#contact_form_username').value.trim();
		const email = document.querySelector('#contact_form_email').value.trim();
		const subject = document.querySelector('#contact_form_subj').value.trim();
		const message = document.querySelector('#contact_form_message').value.trim();
		
		// Check if all fields are filled
		if (name && email && subject && message) {
			// If all fields are not null, show the alert
			const con = document.querySelector('.formAlert');
			...
			// If any field is null, prevent form submission and give user feedback
...
try {
   ...
   //Enable verbose debug output
    ...
    $mail->Username   = 'saumyaignitax@gmail.com';                     //SMTP username
    $mail->Password   = 'ekgmcqxngusgafev';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('saumyaignitax@gmail.com', 'Enquiry');
    $mail->addAddress('221263116011setiit@gmail.com', 'testing');     //Add a recipient
    ...
    $mail->Body    = "Sender Name : $name<br>Sender Mail : $email <br>Message : $msg";

    $mail->send();
    $msgFlag="Message sent!";
} catch (Exception $e) {
